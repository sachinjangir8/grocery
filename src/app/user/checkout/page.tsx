...
import { ArrowLeft, MapPin, CreditCard, Banknote, User, Phone, Landmark, Search, Target, CheckCircle2, Pin, LocateFixed, Loader2 } from 'lucide-react';
                ...
                <motion.div variants={itemVariants} className="space-y-6">
                    <div className="bg-white p-6 md:p-8 rounded-[2rem] shadow-xl shadow-gray-200/50 border border-gray-100">
                        ...
                        <div className="grid gap-4">
                                <motion.div
                                    onClick={() => setPaymentMethod("online" as any)}
                                    whileHover={{ x: 5 }}
                                ...
                                >
                                 ...
                                 <motion.div
                                    onClick={() => setPaymentMethod("cod" as any)}
                                    whileHover={{ x: 5 }}
                        ...
                        <div className="mt-10 space-y-4 pt-8 border-t-2 border-dashed border-gray-100">
                            ...
                            <Link href="/orderplaced" className="block mt-6">
                                <motion.button
